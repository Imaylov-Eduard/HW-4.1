public class Main {
    public static void main(String[] args) {
        ...
        } else System.out.println("Если возраст ребенка больше 5 но меньше 14, то он может кататься на аттракционе только в сопровождении взрослых.");
        if (childsAge1 > 14)
